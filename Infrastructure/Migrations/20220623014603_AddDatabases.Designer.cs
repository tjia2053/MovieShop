...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220623014603_AddDatabases")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Favorite", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Movie", "Movie")
                        .WithMany("FavoritesOfMovies")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.User", "User")
                        .WithMany("FavoritesOfUsers")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Purchase", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Movie", "Movie")
                        .WithMany("PurchasesOfMovies")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.User", "User")
                        .WithMany("PurchasesOfUsers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Review", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Movie", "Movie")
                        .WithMany("ReviewOfMovies")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.User", "User")
                        .WithMany("ReviewsOfUsers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Movie", b =>
                {
                    ...
                    b.Navigation("CrewOfMovies");

                    b.Navigation("FavoritesOfMovies");

                    b.Navigation("GenresOfMovies");

                    b.Navigation("PurchasesOfMovies");

                    b.Navigation("ReviewOfMovies");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.User", b =>
                {
                    b.Navigation("FavoritesOfUsers");

                    b.Navigation("PurchasesOfUsers");

                    b.Navigation("ReviewsOfUsers");
